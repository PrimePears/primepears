...
// Email template for session cancellation
export function getCancellationEmailTemplate(
  ...
  return `
    ...
    <body>
      <div class="container">
        <div class="header">
          <h2>Your ${data.sessionType} Session has been Cancelled</h2>
        </div>
        <div class="content">
          <p>Hello ${data.clientName},</p>
          <p>${data.trainerName} has cancelled your scheduled session:</p>
          ...
          <p>Please contact ${data.trainerName} if you would like to reschedule this session.</p>
          <a href="www.primepears.com" class="cta-button">Reschedule Session</a>
